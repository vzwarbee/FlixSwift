    ...
    <SideBar>
      <div className="flex flex-col gap-6">
        ...
        <div className="flex gap-2 flex-wrap flex-col-reverse sm:flex-row justify-between items-center my-4">
          ...
          <button onClick={()=> toast("sdfsfsaf")} className="bg-main font-medium transitions hover:bg-subMain border border-subMain text-white py-3 px-6 rounded w-full sm:w-auto">
            Update Profile
          </button>
        </div>
      </div>
